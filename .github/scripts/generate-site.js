...
<style>
  ...
  @media (max-width: 680px) {
    ...
    #siteNav { display:none; order:3; width:100%; flex:0 0 100%; box-sizing:border-box; flex-direction:column; align-items:stretch; gap:0; margin:6px -16px -4px; padding:6px 16px 14px; border-top:1px solid #1e293b; }
