...
<style>
  ...
  @media (max-width: 680px) {
    ...
    #siteNav a { display:flex; align-items:center; justify-content:space-between; padding:15px 8px; border-bottom:1px solid #1e293b; font-size:0.95em; }
    #siteNav a::after { content:"›"; color:#475569; font-size:1.2em; }
    #siteNav a.nav-cta { justify-content:center; margin:20px 0 4px; padding:15px; border-radius:8px; border-bottom:none; font-size:0.95em; }
